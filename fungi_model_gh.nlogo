...
to grow-f7s
    ...
    to death-fungi ;die if growth rate < 25% of max
      ask f1s [if cur-growth-rate1 < 0.05 * max-rate1 [die]]
        ask f2s [if cur-growth-rate2 < 0.05 * max-rate2 [die]]
        ask f3s [if cur-growth-rate3 < 0.05 * max-rate3 [die]]
        ask f4s [if cur-growth-rate4 < 0.05 * max-rate4 [die]]
        ask f5s [if cur-growth-rate5 < 0.05 * max-rate5 [die]]
        ask f6s [if cur-growth-rate6 < 0.05 * max-rate6 [die]]
        ask f7s [if cur-growth-rate7 < 0.05 * max-rate7 [die]]
    end
